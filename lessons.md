...
Done can take many different shapes. Perhaps your project...
- ...morphs into something new
- ...is retired
- ...is archived in a repository
- ...is saved on some form of storage media
- ...runs out of funding
...
Now, Describe your 2–3 sentences to a non-expert audience the purpose of your project. Here are some questions to bear in mind:
1. Does it solve a problem?
2. Meet an institutional need?
3. Put an existing resource to new use?

# Identifying Audiences, Constituencies, and Collaborators

Any given project in digital humanities always has at least one audience, whether implicitly or explicitly formulated. Projects typically satisfy more than one audience's need. Some examples of audiences might be:
- _you_ are an audience in your own
- your dissertation advisor or your dissertation committee
- researchers who are interested in your subject area
- other researchers working on related questions

## Who is your audience?

To start outlining an idea of who constitute's your project's audience, we can start by answering a number of questions:
...
Once we have started answering these questions, we have a better idea of the general groups, their interests, and what they bring to the project.

## Profiling the audience

The next step in identifying a well-defined audience for the project is to do some more research and create several narrowly defined profiles. We do so by being as precise as possible while identifying the audience's (a) needs and interests, (b) resources, and (c) limitations.

### Sample 1

<!-- Insert paragraph here with a short description of what the project would be for the audience that we're outlining below. -->
...
<!-- Insert paragraph here with a short description of what the project would be for the audience that we're outlining below. -->
<!-- The audience example is very CUNY Grad Center grad student-centric. We might want to make it less so for the DHRI audience. -->
...
|Resources | The committee is familiar with some of the models that already exist. They have deep familiarity with the qualitative indicators for corporate fraud. They can connect my data and my research to a wider community of scholars who have the datasets that I need to finish my work. My advisor wants me to succeed.
...
## Challenge: Your turn to outline your audience(s)

Use the template below to outline your project's audience/s. You can copy and paste the table for as many audiences as you identify for your project.
...
## Profiling the stakeholders

The next step in identifying a well-defined stakeholder for the project is to follow the same instruction as we did we the audience in the previous lesson. Start by doing some more research on the stakeholder and create several narrowly defined profiles. Be as precise as possible while identifying the stakeholders's (a) needs and interests, (b) resources, and (c) limitations.

## Example of a "stakeholder"

<!-- The stakeholder example is very CUNY-centric. We might want to make it less so for the DHRI audience. -->

| | |
|----|-----|
|Needs/interest | The New Media Lab has student fellows who develop digital projects. They have expressed interest in finding a data management tool that allows students to create a plan for how to handle various types of data files.
|Resources | I'm also a fellow in the New Media Lab, and they might be willing to help test my tool.
|Limitations | They are more interested in using open source software than many of the other students I work with.

## Challenge: Your turn to outline your stakeholder(s)

Use the template below to outline your project's stakeholder/s. You can copy and paste the table for as many audiences as you identify for your project.
...
2. Search and browse through literature in the field and resources for digital tools and innovations. Some examples of places to look include:
	...
	- [American Archivist](http://www2.archivists.org/american-archivist)
	...
	- [PLOS](http://blogs.plos.org/) and [PLOS Collections](http://blogs.plos.org/collections/)
...
4. If there aren't any technologies that do _exactly_ what you were hoping for, has anyone else run into this problem? How did they solve it? Will you need to create a new tools or make significant changes to an existing one to accomplish your goal?
...
We can identify what counts as a "resource" in different ways:
1. data, digital assets, collections<!-- I think all of those would do well with an example... -->
2. technology
3. human
4. institution
<!-- 5. financial <-- since this is not discussed further below, I would leave this out... -->

In the following sections, we will discuss each of those resources in detail.

# Resource Assessment: Data, Digital Assets, Collections

Do you have the dataset you need to do your project? Finding, cleaning, storing, managing changes in, and sharing your data is an often overlooked but _extremely_ important part of designing your project. Successfully finding a good dataset means that you should keep in mind: Is the dataset the appropriate size and complexity to help address your project's goals? Finding, using, or creating a good dataset is a core part of your project's long-term success.
...
**I do not have any data resources at my disposal.**
...
**I do have data resources at my disposal.**
...
When making an inventory of all the technologies in your project, it is a good idea to start by naming all the types of technology that you will need to go from "raw data" to "final project." If you don't know the name of the technology, you can just describe it. That will make it easier for you to find what best fits your description.

As an **example**, if I will scrape texts from poetry websites like poets.org from the internet, I will use a Python library called BeautifulSoup. Next, I will clean my data using Python, explore the data in NLTK to look for coocurrances of the words "painting" and "sea." I will store my results using GitHub, and visualize the results using the D3.js library. I will use these visualizations to write the second half of my article. When the project is done, I will deposit the dataset into the Academic Works repository."

In the next step, you can split up your list into which technology resources you have, on the one hand, and which ones you need, on the other.

## Example of a Resource Assessment
| | |
|----|-----|
| Have | Basic knowledge of git, Python and some of the NLTK library
...
## Challenge: Your turn to identify your technology resources

1. Start by making an inventory of all the technology resources that you can think of in your project.
...
2. Use the template to make a resource assessment table:
...
# Resource Assessment: Human resources
...
Now, look back at what you filled in during the challenge in the workshop's lesson on "Identifying Audiences, Constituencies, and Collaborators": of your audiences who are invested in your work, can you identify any human resources there that you draw on for support?

Next, it is time to turn to your to your **local context**, starting from our institute and moving outward to the larger community:
...
- Is there a digital scholarship librarian at your college?<!-- Dropping things like this, which lived in this bullet point: Have you signed up for the GC Digital Fellows email list? -->
...
Next, it is time to turn to your to your **remote context** to see what human resources might be available to you there:
...
# Effective Partnerships: Identifying Your Needs
...
# Effective Partnerships: Finding Good Collaborators

Now that we have identified our needs and given some thought to who might have those skills, areas of expertise, resources, and interest, it is time get busy.

Finding collaborators can seem like a daunting task to some, especially as it involves quite a bit of social interaction. There are no ways set in stone for identifying collaborators but good ways to get started are by:
...
Once you have found a potential collaborator, or perhaps even a list of them, you will want to make sure that your collaborator is a good fit. Some things to consider in this step are:
...
Once you have identified the collaborators who you would like to invite into your project, the next step is to formalize the partnership. Below, you will find a list of important points to keep in mind at this stage:
...
- Determine who will be the primary contact for inter-institutional communications.
...
An often overlooked part of collaboration is to establish norms for how your collaboration will work. As should be clear from the "Formalize partnerships" section, clearly stating expectations and norms lays important groundwork that will last throughout your collaboration:
...
## Stay flexible and know when to end things
...
A final note: Not all collaborations work out as planned, even with the best of intentions. If there is a major breakdown in communications, or if relationships deteriorate, you may need to break apart partnerships.

# Letters of support

<!-- I think transition might be needed here - between finding collaborators (above) and preparing a grant proposal (below) -->
...
6. Office of Career Services/Development on your campus can be helpful in identifying external fellowships and grants.
...
As we are arriving at the end of the Project Lab workshop, we also arrive at what's usually considered the beginning of the project: the grant proposal. One of the points of this workshop is to lay some important cornerstones for a project process that begins much earlier than many consider the beginning of the project process, and emphasize the importance to give yourself time and space to work on the preparations for the grant proposal well in advance of any grant deadlines.
...
You should be able to use the notes from the earlier lessons in this workshop to start filling out your own project.
...
Now, it is your turn. Use the headers from the "Short Project Proposal" template above and start outlining your own project proposal.
